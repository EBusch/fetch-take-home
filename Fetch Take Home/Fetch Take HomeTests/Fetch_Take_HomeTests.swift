...
struct Fetch_Take_HomeTests {

    /// Tests the deserialization of JSON into models.
    @Test func testRecipeDeserialization() async throws {
        if let jsonData = recipeJson.data(using: .utf8) {
            do {
                ...
                let canadianButterTarts = recipes.first { recipe in
                    recipe.name == "Canadian Butter Tarts"
                }

                #expect(canadianButterTarts != nil)
                #expect(canadianButterTarts?.name == "Canadian Butter Tarts")
                #expect(canadianButterTarts?.uuid == "39ad8233-c470-4394-b65f-2a6c3218b935")
                #expect(canadianButterTarts?.cuisine == "Canadian")
                #expect(canadianButterTarts?.photoUrlLarge == "https://d3jbb8n5wk0qxi.cloudfront.net/photos/f18384e7-3da7-4714-8f09-bbfa0d2c8913/large.jpg")
                #expect(canadianButterTarts?.photoUrlSmall == "https://d3jbb8n5wk0qxi.cloudfront.net/photos/f18384e7-3da7-4714-8f09-bbfa0d2c8913/small.jpg")
                #expect(canadianButterTarts?.sourceUrl == "https://www.bbcgoodfood.com/recipes/1837/canadian-butter-tarts")
                #expect(canadianButterTarts?.youtubeUrl == "https://www.youtube.com/watch?v=WUpaOGghOdo")
            } catch {
    ...
    // This is pulled from the expected JSON.
    let recipeJson = """
    {
      "recipes": [
        {
